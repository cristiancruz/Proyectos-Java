...
public void acceso(){
    ...
    private void btncancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncancelarActionPerformed
     int op = new javax.swing.JOptionPane().showOptionDialog(rootPane, "Seguro que desea cancelar acceso al del sistema?", "Cancelar", javax.swing.JOptionPane.YES_NO_OPTION, javax.swing.JOptionPane.YES_NO_OPTION, null, null, "NO");
        if (op == 0) {
            System.exit(0);
        }
